        ...
        if (mailSender != null) {
            try {
                ...
                String htmlContent = 
                    ...
                    "    <p style=\"font-size: 16px; line-height: 24px; color: #E5E7EB; margin-bottom: 25px; text-align: left;\">Welcome to REVYND, " + userName + "! Use the 6-digit verification code below to verify your email address and complete your registration:</p>" +
    ...
    public void sendPasswordResetCode(String toEmail, String userName, String code) {
        ...
        if (mailSender != null) {
            try {
                ...
                String textContent = userName + ", you requested a password reset for your REVYND account.\n\nUse the verification code below to authorize your password reset:\n\n" + code + "\n\nThis code will expire in 15 minutes.";
                ...
                String htmlContent = 
                    ...
                    "    <div style=\"height: 1px; background-color: #1F2937; margin-bottom: 30px;\"></div>" +
                    "    <p style=\"font-size: 16px; line-height: 24px; color: #E5E7EB; margin-bottom: 25px; text-align: left;\">" + userName + ", you requested a password reset for your REVYND account. Use the 6-digit code below to authorize this change:</p>" +
                    "    <div style=\"background-color: #1F2937; border: 1px solid #374151; border-radius: 12px; padding: 18px 0; margin-bottom: 30px; letter-spacing: 6px; font-size: 32px; font-weight: bold; color: #FFFFFF; font-family: monospace;\">" + code + "</div>" +
